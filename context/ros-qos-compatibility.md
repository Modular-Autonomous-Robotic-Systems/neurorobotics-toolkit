...
| `/airsim_node/Copter/front_center_Scene/image` | `airsim_ros_wrapper.cpp:265` — `image_transport::advertise(topic, 1)` ⇒ VOLATILE, RELIABLE, KEEP_LAST(1) | `slam/src/basalt/node.cpp:100-102` — depth 10 ⇒ VOLATILE, RELIABLE | ✅ |
| `/airsim_node/…/image` | as above | `slam/src/orbslam3/monocular.cpp:78` — depth 10 ⇒ VOLATILE, RELIABLE | ✅ |
