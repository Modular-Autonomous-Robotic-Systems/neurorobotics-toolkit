...
def generate_launch_description():
    ...
    encoder_launch = launch.actions.IncludeLaunchDescription(
        ...
        launch_arguments={
            "input_topic": launch.substitutions.PythonExpression(
                ["'/' + ", "'", ns, "' + '/image_raw'"]
            ),
            "ffmpeg_topic": launch.substitutions.PythonExpression(
                ["'/' + ", "'", ns, "' + '/image_compressed'"]
            ),
        }.items(),
    )
    ...
    logger_launch = launch.actions.IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "log_level": log_level,
            "ap_status_topic_name": launch.substitutions.PythonExpression(
                ["'/' + ", "'", ns, "' + '/tello_state'"]
            ),
            "ap_type": "tello",
        }.items(),
    ...
    # TODO Remove hardcoded topic names from within the controller and tello joy stick node
